...
echo ""
echo -e "${YELLOW}Ve configurando en el archivo .env las API Key que se vayan pidiendo${NC}"
echo -e "${YELLOW}(indicaciones para conseguirlas en /docs/api_key_guide.md)${NC}"
echo "-------------------------------------------------------------------------------------"