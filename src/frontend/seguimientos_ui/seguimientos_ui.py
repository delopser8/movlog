...
.st-emotion-cache-3pwa5w.e1rw0b1u1:in(.seg-row) + .stHorizontalBlock.st-emotion-cache-1permvm.e1rw0b1u3 {
    scale: 0.7;
}
.st-emotion-cache-3pwa5w.e1rw0b1u1:in(.seg-row) + .stHorizontalBlock.st-emotion-cache-1permvm.e1rw0b1u3 p{
    font-size: 1.1em;
}
